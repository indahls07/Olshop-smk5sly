				...
				?>
                    <a href="produk.php?kat=<?php echo $k['category_id'] ?>">
                        <div class="col-5">
                                <?php 
                                if ($k['category_id']==1){
                                    echo'<img src="img/pakaian.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                }
                                if ($k['category_id']==2){
                                    echo'<img src="img/hp.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                }
                                if ($k['category_id']==3){
                                    echo'<img src="img/atk.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                }
                                if ($k['category_id']==4){
                                    echo'<img src="img/otomotif.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                }
                                if ($k['category_id']==5){
                                    echo'<img src="img/komputer.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                } if ($k['category_id']==6){
                                    echo'<img src="img/hijab.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                } if ($k['category_id']==7){
                                    echo'<img src="img/tas.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                } if ($k['category_id']==8){
                                    echo'<img src="img/minuman.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                }
                                if ($k['category_id']==9){
                                    echo'<img src="img/makanan.png" width="50px" style="margin-bottom:5px;" /><p>'; 
                                    
                                }
                                if ($k['category_id']==10){
                                    echo'<img src="img/sepatu.png" width="50px" style="margin-bottom:5px;" /><p>'; 
